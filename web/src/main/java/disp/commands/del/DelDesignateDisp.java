...
import disp.com.del.DelDesignateService;

public class DelDesignateDisp extends Command {
	private static Logger log = Logger.getLogger(DelDesignateDisp.class);

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		BaseService serv = new DelDesignateService();
